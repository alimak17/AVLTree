    ...
    public class BST<T> where T : IComparable<T>
    {
        ...
        public bool Delete(T value)
        {
            ...
            else if (toDelete.left.size >= toDelete.right.size)
            {
                ...
                max.parent.replaceChild(max, max.left);
        ...
        protected void replaceChild(BST<T> oldChild, BST<T> newChild)
        {
            if (left == oldChild)
                left = newChild;
            else
        ...
        protected virtual void PrintTree(int depth)
        {
        ...
        protected bool isLeaf() => left == null && right == null;
